defmodule KsphoenixWeb.EventLiveTest do
  use KsphoenixWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ksphoenix.EventsFixtures

  @create_attrs %{date: "2024-12-12", description: "some description", title: "some title"}
  @update_attrs %{date: "2024-12-13", description: "some updated description", title: "some updated title"}
